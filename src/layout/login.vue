...
<template xmlns="">
  <div class="home-background">
    <div class="home-content">
      <div class="content">
        <img class="school-logo" src="/images/logo.png" alt="" />
        <iframe
        ...
        <div>
          <h1>
            <span>CUZ Web VR</span>
            <img class="cube1" src="../assets/icons/cube.svg" alt="" />
          </h1>
        </div>
        <div class="button-box">
          <div class="container">
            <div class="button">
              <div class="button-content" @click="router.push('/home')">
                <span class="button-text">View VR</span>
                <i class="ri-download-cloud-fill button-icon"></i>
